...
public class FixChildLableGroup extends ViewGroup {
    ...
    public FixChildLableGroup(Context context) {
        this(context,null);
    }

    public FixChildLableGroup(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public FixChildLableGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr,0);
    }

    public FixChildLableGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
