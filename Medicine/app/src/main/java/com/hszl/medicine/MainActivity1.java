...
public class MainActivity1 extends BaseActivity {
    ...
    LinearLayout llTop;
    ImageView ivTop;
    TexTAdapterModelTest1 adapter,imageAdapter,imageAdapter1,imageAdapter2,imageAdapter3,imageAdapter4;
...
//    ImageAdapter imageAdapter4;                //报表统计
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new TexTAdapterModelTest1(this,list1);
        ViewGroupImpl.addView(lgStatistics,adapter,true);
//        adapter=new TexTAdapterModelTest1(list1,this);
...
//                    imageAdapter=new ImageAdapterModelTest(list2,this);
...
//                    imageAdapter1=new ImageAdapterModelTest(list3,this);
...
//                    imageAdapter2=new ImageAdapterModelTest(list4,this);
...
//                    imageAdapter3=new ImageAdapterModelTest(list5,this);
...
//                    imageAdapter4=new ImageAdapterModelTest(list6,this);
