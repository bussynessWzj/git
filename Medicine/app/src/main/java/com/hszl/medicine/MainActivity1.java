...
public class MainActivity1 extends BaseActivity implements ViewGroupItemClickListener {
    ...
    ImageAdapterModelTest2 imageAdapter, imageAdapter1, imageAdapter2, imageAdapter3, imageAdapter4;
    ...
    private void initBodyView() {
        for (int i = 0; i < list.size(); i++) {
            switch (list.get(i).getId()) {
                case R.id.fclgSaler:
                    imageAdapter = new ImageAdapterModelTest2(this, list2);
                    Saler = new ViewGroupImpl(imageAdapter);
                    Saler.addView(fclgSaler, imageAdapter, true);
                    Saler.setOnItemClickListener(fclgSaler, this);
                    break;
                case R.id.fclgPaymentReceived:
                    imageAdapter1 = new ImageAdapterModelTest2(this, list3);
                    PaymentReceived = new ViewGroupImpl(imageAdapter1);
                    PaymentReceived.addView(fclgPaymentReceived, imageAdapter1, true);
